...
pub fn run(conn: &Connection, name: &str, json: bool) {
    ...
    if let Some(complications) = complications_map.get(key) {
        ...
        println!(
            "  {}",
            "⚕️  Early treatment significantly reduces complication risk.".yellow()
        );
        println!(
            "  {}",
...
fn build_complications_map() -> HashMap<&'static str, Vec<Complication>> {
    ...
    map.insert(
        ...
        vec![
            Complication {
                condition: "Diabetic retinopathy (vision loss)",
                risk: "high",
                timeframe: "5-10 years",
                preventable: true,
            },
            Complication {
                condition: "Diabetic nephropathy (kidney failure)",
                risk: "high",
            ...
            Complication {
                condition: "Diabetic foot ulcers / amputation",
                risk: "moderate",
                timeframe: "years",
                preventable: true,
            },
    ...
    map.insert(
        ...
        vec![
            Complication {
                condition: "Cerebral malaria (coma, seizures)",
                risk: "high",
                timeframe: "days",
                preventable: true,
            },
            ...
            Complication {
                condition: "Pulmonary edema / ARDS",
                risk: "moderate",
                timeframe: "days",
                preventable: true,
            },
    ...
    map.insert(
        ...
        vec![
            ...
            Complication {
                condition: "Pleural effusion / empyema",
                risk: "moderate",
                timeframe: "days-weeks",
                preventable: true,
            },
    ...
    map.insert(
        ...
        vec![
            Complication {
                condition: "Perforation and peritonitis",
                risk: "high",
                timeframe: "24-72 hours",
                preventable: true,
            },
            Complication {
                condition: "Abscess formation",
                risk: "moderate",
                timeframe: "days",
                preventable: true,
            },
    ...
    map.insert(
        ...
        vec![
            Complication {
                condition: "Severe dehydration and shock",
                risk: "high",
                timeframe: "hours",
                preventable: true,
            },
            Complication {
                condition: "Hypokalemia (cardiac arrhythmia)",
                risk: "high",
                timeframe: "hours",
                preventable: true,
            },
            ...
            Complication {
                condition: "Hypoglycemia (especially children)",
                risk: "moderate",
                timeframe: "hours",
                preventable: true,
            },
    ...
    map.insert(
        ...
        vec![
            ...
            Complication {
                condition: "Corneal ulceration / blindness",
                risk: "moderate",
                timeframe: "weeks",
                preventable: true,
            },
    ...
    map.insert(
        ...
        vec![
            Complication {
                condition: "Paralysis / disability",
                risk: "high",
                timeframe: "immediate",
                preventable: false,
            },
    ...
    map.insert(
        ...
        vec![
            Complication {
                condition: "Rheumatic heart disease (valve damage)",
                risk: "high",
                timeframe: "weeks-months",
                preventable: true,
            },
    ...
    map.insert(
        ...
        vec![
            Complication {
                condition: "Severe iron-deficiency anemia",
                risk: "high",
                timeframe: "months",
                preventable: true,
            },
            Complication {
                condition: "Growth retardation in children",
                risk: "high",
                timeframe: "months-years",
                preventable: true,
            },
            ...
            Complication {
                condition: "Cognitive impairment in children",
                risk: "moderate",
                timeframe: "years",
                preventable: true,
            },
    ...
    map.insert(
        ...
        vec![
            ...
            Complication {
                condition: "Irreversible blindness",
                risk: "high",
                timeframe: "years-decades",
                preventable: true,
            },
            Complication {
                condition: "Trichiasis (inturned eyelashes)",
                risk: "high",
                timeframe: "years",
                preventable: true,
            },
...
mod tests {
    ...
    fn test_complication_map_populated() {
        ...
        assert!(
            map.len() >= 10,
            "Should have complications for at least 10 diseases"
        );
    }
}
